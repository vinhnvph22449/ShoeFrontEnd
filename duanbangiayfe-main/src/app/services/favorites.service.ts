...
export class FavoritesService {
  ...
  getByproductdetailIidAndEmail(id: string, email: string) {
    return this.httpClient.get(this.url+'/'+id+'/'+email);
  }
  


  getByproductdetail(favoriteId: string) {
    return this.httpClient.get(this.url+'/productdetail/'+ favoriteId);
  }
